  ...
  <div class="login-container">
    ...
    <div class="login-card glass-panel animate-fade-in">
      ...
      <div class="oauth-section">
        <button class="oauth-btn sso-btn" @click="loginWith('sso')">
          <svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
            <path d="M7 11V7a5 5 0 0 1 10 0v4" />
          </svg>
          SynchronizeTeams SSO
        </button>
...
.sso-btn {
  background: linear-gradient(135deg, hsl(263, 70%, 50%) 0%, hsl(244, 75%, 58%) 100%);
  color: white;
  border: none;
  font-weight: 600;
...
.sso-btn:hover {
  background: linear-gradient(135deg, hsl(263, 70%, 55%) 0%, hsl(244, 75%, 63%) 100%);
